/* lite.h
 *
 * tizbin System dispatcher module for SQLite DB
 *
 */
...
/* XI dir */
#define XS_DB_INSTALL_DIR     "/opt/tizbin"
#define XS_DB_FILE            XS_DB_INSTALL_DIR"/tzb.db" /* DB file path */
...
/* file paths type
   if XS_ONE_FILE_PATHS is 0 the file paths are stored in /opt/tizbin/pol_x/lastdata.txt files,
   if XS_ONE_FILE_PATHS is 1 the file paths are stored in /opt/tizbin/lastdata.txt for every pol
*/
