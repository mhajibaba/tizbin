...
<div class="container mt-5">
	<h2 class="mb-4 text-center">NNTP articles</h2>
	<table id="listmsn" class="table table-striped table-bordered  nowrap" style="width:100%">
        ...
        <tbody>
              <?php foreach ($list as $row) {
                  ...
                  echo "<td><strong>".$row['receivers']."</strong></td>";
                  echo "<td class=''><strong>".$row['subject']."</strong></td>";
                  echo "<td class=''><strong>".$row['data_size']."</strong></td>";
									echo "<td><a target=\"_blank\" href=flow.php?file=".$row['mime_path'].">".basename($row['mime_path'])."</a></td>";
