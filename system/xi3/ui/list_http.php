...
<div class="container mt-5">
	<h2 class="mb-4 text-center">HTTP Files</h2>
  <table id="listtelnet" class="table table-striped table-bordered  nowrap" style="width:100%">
        ...
        <tbody>
              <?php foreach ($list as $row) {
                  ...
                  echo "<td><strong>".$truncated."</strong></td>";
                  echo "<td>".chunk_split($row['url'], 35, '<br>')."</td>";
                  echo "<td><strong>".$row['file_size']."</strong></td>";
                  echo "<td><strong>".$row['file_stat']."</strong></td>";
									echo "<td><a target=\"_blank\" href=flow.php?file=".$row['file_path'].">".basename($row['file_path'])."</a></td>";
                  echo "<td><a target=\"_blank\" href=flow.php?file=".$row['file_parts'].">".basename($row['file_parts'])."</a></td>";
