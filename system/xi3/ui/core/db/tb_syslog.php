...
class TableSyslog
{
 		...
 		public static function list($sid)
    {
        try {
            ...
            $statement = $db->prepare("SELECT `id`, `capture_date`, `hosts`, ".
            " `log_size`, `flow_info`, `log` from `".self::$table."` " .
                " WHERE `sol_id`= :sid");
    ...
    public static function get_stat($sid)
    {
        try {
            ...
            $statement = $db->prepare("SELECT hosts,max(log_size) as max ".
