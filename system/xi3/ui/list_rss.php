...
<div class="container mt-5">
	<h2 class="mb-4 text-center">RSS feeds</h2>
  <table id="listtelnet" class="table table-striped table-bordered  nowrap" style="width:100%">
        ...
        <tbody>
              <?php foreach ($list as $row) {
                  ...
                  echo "<td><strong>".$row['site']."</strong></td>";
                  echo "<td><a target=\"_blank\" href=list_rssxml.php?fid=".$row['id'].">Click Here</a></td>";
                  echo "</tr>";
              }
              ?>
        </tbody>
