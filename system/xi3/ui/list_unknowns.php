...
<div class="container mt-5">
	<h2 class="mb-4 text-center">Undecoded TCP-UDP</h2>
  <table id="listtelnet" class="table table-striped table-bordered  nowrap" style="width:100%">
        ...
        <tbody>
              <?php foreach ($list as $row) {
                  ...
                  echo "<td><strong>".$row['dst']."</strong></td>";
									echo "<td><strong>".$row['dst_port']."</strong></td>";
									echo "<td><strong>".$row['l7prot']."</strong></td>";
									echo "<td><strong>".$row['size']."</strong></td>";
