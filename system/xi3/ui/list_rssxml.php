...
$list = TableFeeds::listxml($sid,$feedId);
//var_dump($list);
?>
</head>
<body>
...
<div class="container mt-5">
	<h2 class="mb-4 text-center">RSS information</h2>
  <table id="listtelnet" class="table table-striped table-bordered  nowrap" style="width:100%">
        ...
        <tbody>
              <?php foreach ($list as $row) {
                  ...
                  echo "<td><strong>".$feedId."</strong></td>";
                  ...
                  echo "<td><strong>".$row['rs_bd_size']."</strong></td>";
