...
<div class="container mt-5">
	<h2 class="mb-4 text-center">FTP connections</h2>
  <table id="listtelnet" class="table table-striped table-bordered  nowrap" style="width:100%">
        ...
        <tbody>
              <?php foreach ($list as $row) {
                  ...
                  echo "<td><a target=\"_blank\" href=list_ftpfiles.php?fid=".$row['id'].">".$row['url']."</a></td>";
                  echo "<td class=''><strong>".$row['username']."</strong></td>";
									echo "<td class=''><strong>".$row['password']."</strong></td>";
                  echo "<td class=''><strong>".$row['download_num']."</strong></td>";
									echo "<td class=''><strong>".$row['upload_num']."</strong></td>";
									echo "<td><a target=\"_blank\" href=flow.php?file=".$row['cmd_path'].">".basename($row['cmd_path'])."</a></td>";
