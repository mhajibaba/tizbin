...
<div class="container mt-5">
	<h2 class="mb-4 text-center">Syslogs</h2>
  <table id="listtelnet" class="table table-striped table-bordered  nowrap" style="width:100%">
        ...
        <tbody>
              <?php foreach ($list as $row) {
                  ...
                  echo "<td><strong>".$row['hosts']."</strong></td>";
									echo "<td class=''><strong>".$row['log_size']."</strong></td>";
									echo "<td><a target=\"_blank\" href=flow.php?file=".$row['log'].">".basename($row['log'])."</a></td>";
