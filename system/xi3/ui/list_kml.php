...
<div class="container mt-5">
	<h2 class="mb-4 text-center">KML files</h2>
	<h6 class="mb-4 text-center"><a href="show_map.php" class="small"> Show sample KML on map</a></h6>
        ...
        <tbody>
              <?php foreach ($list as $row) {
                  ...
                  echo "<td class='font-weight-bold' style='color:#55ac14'>".$row['filename']."</td>";
									echo "<td><a target=\"_blank\" href=flow.php?file=/opt/tizbin/pol_1/sol_".$sid."/gea/".$row['filename'].".kml>".$row['filename'].".kml</a></td>";
                  echo "</tr>";
              }
              ?>
        </tbody>
