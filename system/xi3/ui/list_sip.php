...
<div class="container mt-5">
	<h2 class="mb-4 text-center">SIP Sessions</h2>
	<table id="listmsn" class="table table-striped table-bordered  nowrap" style="width:100%">
        ...
        <tbody>
              <?php foreach ($list as $row) {
                  ...
                  echo "<td><strong>".$row['from_addr']."</strong></td>";
                  echo "<td><strong>".$row['to_addr']."</strong></td>";
                  echo "<td class=''><strong>".$hms."</strong></td>";
									echo "<td><a target=\"_blank\" href=flow.php?file=".$row['commands'].">".basename($row['commands'])."</a></td>";
