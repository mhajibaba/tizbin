...
<div class="container mt-5">
	<h2 class="mb-4 text-center">ARPs</h2>
  <table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
        ...
        <tbody>
              <?php foreach ($list as $row) {
                  ...
                  echo "<td><strong>".$row['mac']."</strong></td>";
                  echo "<td class=''><strong>".$row['ip']."</strong></td>";
									echo "<td><a target=\"_blank\" href=flow.php?file=".$row['flow_info'].">".basename($row['flow_info'])."</a></td>";                  echo "</tr>";
              }
              ?>
        </tbody>
    </table>
