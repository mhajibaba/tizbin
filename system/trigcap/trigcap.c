...
#define TC_VER_MIN      1
#define TC_VER_REV      0
#define TC_CR           "Part of tizbin Internet Traffic Decoder (NFAT).\nSee http://www.tizbin.org for more information.\n\nCopyright 2007-2011 There is NO warranty; not even for MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.\n"
