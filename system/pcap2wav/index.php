...
<div class="navbar navbar-fixed-top">
    <div class="navbar-inner">
        <div class="container">
            ...
            <a class="brand" href="http://pcap2wav.tizbin.org">PCAP2WAV</a>
            <div class="nav-collapse">
                <ul class="nav">
                    <li class="active"><a href="#">Demo</a></li>
                    <li><a href="http://www.tizbin.org">tizbin</a></li>
                    <li><a href="http://www.tizbin.net">OgbAnalysis</a></li>
                    <li><a href="mailto:tizbin[at]iserm.com">Contact us</a></li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="container">
    ...
    <div class="span6">
<div class="well">
       <p><strong>Codecs supported</strong>: G711ulaw, G711alaw, G722, G729, G723, G726 and <strong>RTAudio (x-msrta: Real Time Audio)</strong>.<br/>PCAP2WAV is an <a href="http://www.tizbin.org">tizbin</a> customization and it runs in <strong>Linux</strong>.</p>
    </div>
    </div>
    </div>
    </div>
